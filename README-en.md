...
**pwcrack-framework** is a password automatic cracking framework written in Ruby, currently provides 25 online cracks and 18 offline crack interfaces, supporting 42 algorithms to crack.
